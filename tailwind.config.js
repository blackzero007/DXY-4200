    ...
    extend: {
      ...
      keyframes: {
        ...
        'online-dot': {
          ...
          '50%': { opacity: '0.85', boxShadow: '0 0 0 3px rgba(16, 185, 129, 0)' },
        },
        'float-slow': {
      ...
      animation: {
        ...
        'online-pulse': 'online-pulse 2.2s ease-in-out infinite',
        'online-dot': 'online-dot 1.8s ease-in-out infinite',
